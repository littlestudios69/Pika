...
module.exports.execute = async(bot, msg, args, data) => {
    ...
    if(validcurrencies[base] === undefined) return msg.reply("Please give me a valid currency you want to convert from!")
    if(!target) return msg.reply("Please give me the Currency you want to convert to!")
    if(validcurrencies[target] === undefined) return msg.reply("Please give me a valid currency you want to convert to!")
    ...
    try {
        ...
        .setDescription(`**__Finished__**\n**Amount:** ${formatNumber(amount)}\n**Base:** ${validcurrencies[base].currencyName} (${base})\n**Target:** ${validcurrencies[target].currencyName} (${target})\n\n**__Result:__**\n${formatNumber(amount)} ${(validcurrencies[base].currencySymbol != undefined ? validcurrencies[base].currencySymbol : base)} is ${formatNumber(amount* rate)} ${(validcurrencies[target].currencySymbol != undefined ? validcurrencies[target].currencySymbol : target)}.`)
        .setColor("GREEN")
